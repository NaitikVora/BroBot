package com.cyberpunk.bruh.bot;
...
public class MainActivity extends AppCompatActivity {
   ...
   /*    if (ActivityCompat.checkSelfPermission(MainActivity.this,
        ...
        File jayDir = new File(getCacheDir().toString() + "/yash/bots/bruhbot");
        boolean b = jayDir.mkdirs();

        if (jayDir.exists()) {
            //Reading the file
            try {
                for (String dir : assets.list("bruhbot")) {
                    File subdir = new File(jayDir.getPath() + "/" + dir);
                    boolean subdir_check = subdir.mkdirs();
                    for (String file : assets.list("bruhbot/" + dir)) {
                        ...
                        in = assets.open("bruhbot/" + dir + "/" + file);
        ...
        bot = new Bot("bruhbot", MagicStrings.root_path, "chat");
        chat = new Chat(bot);
        //String args = null;
